    ...
    return (
        <div className="">
                    ...
                    <div className="row row-cols-2 row-cols-md-6">
                        <div className="col mb-3">
                            <div className="card p-3  h-100" style={{ borderRadius: '8px', border: '1px solid #D1DBE8', background: '#F7FAFC' }}>
                                ...
                                <h6 className="font-weight-bold" style={{ color: "black" }}>Innovation</h6>
                        ...
                        <div className="col mb-3">
                            <div className="card p-3  h-100" style={{ borderRadius: '8px', border: '1px solid #D1DBE8', background: '#F7FAFC' }}>
                                ...
                                <h6 className="font-weight-bold" style={{ color: "black" }}>Empowerment</h6>
                        ...
                        <div className="col mb-3">
                            <div className="card p-3  h-100" style={{ borderRadius: '8px', border: '1px solid #D1DBE8', background: '#F7FAFC' }}>
                                ...
                                <h6 className="font-weight-bold" style={{ color: "black" }}>Success</h6>
                        ...
                        <div className="col mb-3">
                            <div className="card p-3  h-100" style={{ borderRadius: '8px', border: '1px solid #D1DBE8', background: '#F7FAFC' }}>
                                ...
                                <h6 className="font-weight-bold" style={{ color: "black" }}>Integrity</h6>
                        ...
                        <div className="col mb-3">
                            <div className="card p-3  h-100" style={{ borderRadius: '8px', border: '1px solid #D1DBE8', background: '#F7FAFC' }}>
                                ...
                                <h6 className="font-weight-bold" style={{ color: "black" }}>Excellence</h6>
            ...
            <div className='container mt-4'>
                <h3 className=' display-7 fw-bold mb-3'>Discover How We’re Shaping the Future</h3>
            ...
            <div className='container mt-4'>
                ...
                <p className='text-justify'>
                    <b>Empowering Communities, One Innovation at a Time</b><br /> <br />We are committed to enhancing lives and businesses through cutting-edge technology. From tailored educational programs and advanced AI solutions to smart mobility services, our mission is to create opportunities and drive progress, one step at a time.
                </p>
                <hr className='my-5' />
            </div>

            <div className='container mt-4'>
                <h3 className=' display-7 fw-bold mb-4'>Our Values</h3>
                <p className='text-justify'>
                    <b>Innovate with Purpose </b>: We are driven by a desire to create meaningful change and solve real-world problems with our technology.<br/><br/>
                    <b>Empower and Include</b>: We believe in the power of inclusivity and strive to uplift every community we serve.<br/><br/>
                    <b>Collaborate for Success</b>: Success is a team effort. We work together, share ideas, and support one another to achieve our common goals.<br/><br/>
                    <b>Act with Integrity</b>: We uphold the highest standards of honesty and transparency in all our dealings.<br/><br/>
                    <b>Commit to Excellence</b>: We take ownership of our work and are dedicated to delivering exceptional results.<br/><br/>
                    <b>Embrace Sustainability</b>: We are committed to minimizing our environmental impact through eco-friendly practices and sustainable solutions in all operations.
                </p>
                <hr className='my-5' />
            </div>
                        ...
                        <div className="row mt-4">
                            <div className="col-6 col-md-2 mb-4">
                                <div className="card bg-transparent text-white h-100 border-0">
                                    <img src="/TestImages/Jas.jpeg" className="card-img-top" alt="AI Solution" style={{ borderRadius: '14px 14px 64px 14px', background: 'url(/TestImages/10.png) lightgray 50% / cover no-repeat', height: '25vh', objectFit: 'cover', objectPosition: 'center' }} />
